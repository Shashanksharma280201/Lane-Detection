...
path = r"/home/flo/Videos/lane_followind_ros_ws/src/self_driving/Detection/Lanes/selected_images_path"
...
class Video_get(Node):
    def __init__(self):
        ...
        # Add parameters for camera topic
        self.declare_parameter('camera_topic', '/color/video/image')
        self.camera_topic = self.get_parameter('camera_topic').value
        
        # Create subscribers with proper error handling
        ...
        # Add logging
        self.get_logger().info(f'Initialized. Listening on topic: {self.camera_topic}')
    ...
    def process_data(self, data): 
        try:
            ...
            if text == "red_light":
                self.vel = "" 
            elif text == "green_light":
                self.vel = ""              
            
            # Publish result
            self.msg.data = str(self.vel)
